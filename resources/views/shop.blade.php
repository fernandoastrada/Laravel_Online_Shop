        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" id="pagesize"
              ...
              <option value="80" {{$size == 80 ? 'selected':''}} style="text-align: center"> 80</option>
              <option value="100" {{$size == 100 ? 'selected':''}} style="text-align: center"> 100</option>
            </select>

            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Order by" id="orderby"
              name="orderby" style="margin-right: 20px;">
